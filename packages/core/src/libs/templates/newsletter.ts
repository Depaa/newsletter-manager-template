...
table, td { color: #000000; } #u_body a { color: #ffa31a; text-decoration: underline; } @media (max-width: 480px) { #u_row_2.v-row-padding--vertical { padding-top: 0px !important; padding-bottom: 0px !important; } #u_column_2 .v-col-padding { padding: 0px !important; } }
    </style>
