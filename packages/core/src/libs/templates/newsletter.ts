  ...
  <head>
    ...
    <style type="text/css">
      ...
      * {
      ...
      /*! CSS Used from: https://cloudnature.net/_app/immutable/assets/styles.9adc5e69.css */
      #content-container img[data-emoji] {
        display: inline-block;
        vertical-align: middle;
        margin-left: 0;
        margin-right: 0;
      ...
      #content-container pre.code-container {
        background: #282c34;
                                  ...
                                  <tr>
                                    ...
                                    >
                                      <img
                                        align="center"
                                        border="0"
                                        src="https://i.imgur.com/9NbEkTR.jpeg"
                                        alt="Thank You"
                                        title="Thank You"
                                        style="
                                          outline: none;
            ...
            >
              ...
              >
                ...
                >
                  ...
                  <!--[if (mso)|(IE)]><td align="center" width="800" class="v-col-padding" style="width: 800px;padding: 0px;border-top: 0px solid transparent;border-left: 0px solid transparent;border-right: 0px solid transparent;border-bottom: 0px solid transparent;border-radius: 0px;-webkit-border-radius: 0px; -moz-border-radius: 0px;" valign="top"><![endif]-->
                  <div
                    class="u-col u-col-100"
                    style="
                      max-width: 320px;
                                    ...
                                    >
                                      <tbody>
                                        <tr style="vertical-align: top">
                                          ...
                                          >
                                            <a
                                              href="https://www.linkedin.com/in/matteo-depascale/"
                                              title="LinkedIn"
                                              target="_blank"
                                            >
                                              <img
                                    ...
                                    >
                                      <tbody>
                                        <tr style="vertical-align: top">
                                          ...
                                          >
                                            <a
                                              href="https://twitter.com/DepascaleMatteo"
                                              title="Twitter"
                                              target="_blank"
                                            >
                                              <img
                                    ...
                                    <span
                                      style="
                                        ...
                                        font-family: arial, helvetica,
                                          sans-serif;
                                      "
                                      >If you ever have questions or just want
